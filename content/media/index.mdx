...
詳細は[Community設計](/community)、[ユースケース](./use-cases)、[論理データモデル](./data-model)、[物理データモデル](./physical-data-model)、[レコードパターン](./record-patterns)、[整合性とTransaction](./consistency-transactions)、[Media処理と派生物](./processing)を参照してください。
