...
Media本体はメディア情報だけを表し、管理主体は独立した`media_custodies`で関連付けます。個人領域へのuploadではUser、Communityへの直接uploadではCommunityが初期Custodianです。Communityへ投稿した事実だけで投稿者に特別な管理権限は付与しません。例外の要否は[Issue #36](https://github.com/hazuki3417/memoria-design/issues/36)で検討します。
