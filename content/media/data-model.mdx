...
Community、Membership、Community Administrator、招待URL、参加申請を管理します。Administratorは有効なMembershipを持ち、Communityごとに常に1人以上存在します。Communityはネストせず、参加者・Media・権限を別Communityへ継承しません。MembershipはCommunity共有Mediaを閲覧し、Uploader権限を行使する前提です。

招待URLはCommunityに所属し、7日間有効です。参加申請は未承認のものだけCommunity・Userごとに1件とし、Administratorの承認でMembershipを作成します。詳細は[Community論理データモデル](/community/data-model)を参照します。
