...
Invitation acceptではURLの有効性、Communityの存在、Membershipが存在しないことを確認し、Invitationのconsumeと`role=member`のMembership作成を同じTransactionで確定します。参加済みUser、期限切れ・無効化済みInvitation、削除済みCommunityでは新しいMembershipを作成しません。
